...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.hum_edit = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.temp_edit = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.refreshButton.clicked.connect(self.get_value_from_db)
...
if __name__ == "__main__":
    ...
    MainWindow.show()
    #connection = sqlite3.connect("user.db")
    #connection.execute("CREATE TABLE DATA(TEMP_VALUE TEXT NOT NULL, HUM_VALUE TEXT NOT NULL, TIME_DATE_VALUE TEXT NOT NULL)")
    sys.exit(app.exec_())
